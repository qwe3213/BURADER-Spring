...
//    		logger.debug("@@@@@@ContractService : 한번 끝");
	...
	public int getListAllContractVO() throws Exception {
		logger.debug("@@@@@@ContractService : getListAllContractVO 메소드 호출!");
		return cdao.getListAllContractVO();
	}

	// 아무조건이 없을 때 전체 목록갯수 가져오기
	public int getListPageSizeAllContractVO(ContractVO cvo) throws Exception {
		logger.debug("@@@@@@ContractService : getListPageSizeAllContractVO 메소드 호출!");
		return cdao.getListPageSizeAllContractVO(cvo);
	};

	// 검색어+페이징처리 전체 목록갯수 가져오기
	public int getListSearchAllContractVO(ContractVO cvo) throws Exception {
		logger.debug("@@@@@@ContractService : getListSearchAllContractVO 메소드 호출!");
		return cdao.getListSearchAllContractVO(cvo);
	};
	...
	public List<ContractVO> getListPageSizeObjectContractVO(ContractVO cvo) throws Exception {
		...
		return cdao.getListPageSizeObjectContractVO(cvo);
	};
	...
	public List<ContractVO> getListSearchObjectContractVO(ContractVO cvo) throws Exception {
		...
		return cdao.getListSearchObjectContractVO(cvo);
	};
	//////////////////////////////// 페이징처리/////////////////////////////////////
